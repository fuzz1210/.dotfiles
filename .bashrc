...
if [ -f $(brew --prefix)/etc/bash_completion.d/tig-completion.bash ]; then
    . $(brew --prefix)/etc/bash_completion.d/tig-completion.bash
else
    echo 'Please through the path of `tig-completion.bash`, if you will use gitcli.'
fi
